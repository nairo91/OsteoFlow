...
const SERVICES = [
    ...
    { id: 3, title: 'Urgence Douleur', duration: '30 min', price: 55, desc: 'Focus immédiat sur le soulagement de la douleur.' },
];

const TESTIMONIALS = [
    { id: 1, name: "Sarah J.", role: "Coureuse", text: "Je ne pouvais plus courir depuis des mois. Deux séances et je suis de retour sur la piste. Incroyable.", rating: 5 },
    { id: 2, name: "Marc Dupont", role: "Employé de bureau", text: "Les tensions dans la nuque à cause de l'écran étaient insupportables. Le soulagement a été immédiat.", rating: 5 },
    { id: 3, name: "Elena R.", role: "Jeune Maman", text: "Doux, professionnel et très rassurant. Je recommande vivement pour la récupération post-partum.", rating: 5 }
];
...
const BookingModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-sm p-0 sm:p-4">
            {/* Contenu Modal */}
            <div className="bg-white w-full max-w-lg h-[90vh] sm:h-auto sm:max-h-[85vh] rounded-t-3xl sm:rounded-3xl shadow-2xl flex flex-col animate-slide-up sm:animate-fade-in overflow-hidden">

                {/* En-tête */}
                <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white sticky top-0 z-10">
                    <div className="flex items-center gap-2">
                        {step > 1 && step < 5 && (<button onClick={prevStep} className="p-1 hover:bg-slate-100 rounded-full text-slate-500">
                            <ChevronLeft size={20} />
                        </button>
                        )}
                        ...
                        <div className="space-y-3 animate-fade-in">
                            {SERVICES.map(service => (
                                <div key={service.id} onClick={() => { setSelection({ ...selection, service }); nextStep(); }}
                                    className="group bg-white p-4 rounded-xl border border-slate-200 hover:border-emerald-500 hover:shadow-md cursor-pointer transition-all flex justify-between items-center"
                                >
                                    <div>
            ...
            ${!slot.available
                                                        ...
                                                        : 'bg-white border-emerald-100 text-emerald-700 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 shadow-sm'}
            `}
                                            >
                                                {slot.time}
                                            </button>
                    ...
                    {step === 3 && (
                        <div className="space-y-4 animate-fade-in">
                            ...
                            <form className="space-y-3">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 mb-1 uppercase tracking-wide">Motif de consultation (Optionnel)</label>
                    ...
                    {step === 5 && (
                        <div className="flex flex-col items-center justify-center h-full text-center py-8 animate-fade-in">
                            ...
                            <p className="text-slate-500 mb-8 max-w-xs">Nous avons envoyé un SMS de confirmation sur votre téléphone. À bientôt le {selection.date} Oct à {selection.time}.</p>
                            ...
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 w-full mb-6 text-left">
                                ...
                                <ul className="text-sm text-slate-500 space-y-2">
                                    <li className="flex gap-2 items-start"><span className="text-emerald-500">•</span> Vous recevrez un rappel 24h avant.</li>
                                    <li className="flex gap-2 items-start"><span className="text-emerald-500">•</span> Merci d'arriver 5 minutes en avance.</li>
                                </ul>
                            </div>
                    ...
                    <div className="divide-y divide-slate-50">
                        {[
                            ...
                            <div key={i} className="p-4 flex gap-4 items-center hover:bg-slate-50 transition-colors">
                                ...
                                <div className={`w-2 h-2 rounded-full ${appt.status === 'Terminé' ? 'bg-slate-300' : appt.status === 'En cours' ? 'bg-emerald-500 animate-pulse' : 'bg-orange-400'}`}></div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <nav className="fixed w-full z-40 bg-white/80 backdrop-blur-md border-b border-slate-100 transition-all">
                <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-xl tracking-tight text-slate-900">Osteo<span className="text-emerald-700">Flow</span></span>
                    </div>
            ...
            <section className="pt-32 pb-20 px-4 md:px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 animate-fade-in">
                    ...
                    <p className="text-lg text-slate-500 max-w-md leading-relaxed">
                        Soins ostéopathiques experts spécialisés dans le mal de dos, les blessures sportives et le stress. Retrouvez votre mobilité dans un cabinet calme et moderne.
                    </p>
                ...
                <div className="relative h-[400px] md:h-[500px] bg-slate-100 rounded-[2rem] overflow-hidden shadow-2xl animate-fade-in delay-100 group">
                    <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=1000" alt="Cabinet Moderne"
            ...
            <section className="bg-slate-50 py-20 px-4 md:px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-2xl mx-auto">Nous ne traitons pas seulement les symptômes, nous trouvons la cause. Choisissez la séance adaptée à vos besoins.</p>
                    </div>
            ...
            <footer className="bg-slate-900 text-slate-400 py-12 px-4 border-t border-slate-800">
                <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="max-w-xs text-sm">Soins ostéopathiques professionnels dédiés au rétablissement de l'équilibre naturel et du mouvement de votre corps.</p>
                    </div>
                    <div>
        ...
        <div className="relative bg-white h-full w-full">
            ...
            <div className="fixed bottom-4 left-4 z-50 opacity-50 hover:opacity-100 transition-opacity">
                <button onClick={() => setView(v => v === 'landing' ? 'admin' : 'landing')}
                    className="bg-slate-800 text-xs text-white px-3 py-1 rounded-full shadow-lg border border-slate-700 flex items-center gap-2"
                >
                    {view === 'landing' ?
                        <Lock size={10} /> :
                        <User size={10} />}
